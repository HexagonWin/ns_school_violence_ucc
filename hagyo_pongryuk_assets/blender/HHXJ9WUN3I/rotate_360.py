...
params['Alongtimeago'] = u'DST2P_dontstealt2production'
params['specular_intensity'] = 0.5
params['Episode'] = u'Studio T2 Production'
...
params['width'] = 1.0
params['MainText'] = u'This video is for internal testing purposes only. Do not leak this video, this is only made for internal use on this team. DO NOT LEAK. Copyright 2021 Studio T2 production.'
params['extrude'] = 0.1
params['alpha_mode'] = 1
...
params['quality'] = 100
params['output_path'] = u'/home/hexagonwin/hagyo/hagyo_pongryuk_assets/blender/HHXJ9WUN3I/TitleFileName'
